<h2><a href="https://www.geeksforgeeks.org/problems/print-n-to-1-without-loop/1?page=1&category=Recursion&difficulty=School,Basic,Easy&sortBy=submissions">Print N to 1 without loop</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Print numbers from <strong>N to 1</strong>&nbsp;(space separated) without the help of loops.</span></p>
