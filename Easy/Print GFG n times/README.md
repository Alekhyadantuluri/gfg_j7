<h2><a href="https://www.geeksforgeeks.org/problems/print-gfg-n-times/1?page=1&category=Recursion&difficulty=School,Basic,Easy&sortBy=submissions">Print GFG n times</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Print GFG n times without the loop.</span></p>
